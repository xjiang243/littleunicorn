...
<body>
    ...
    <div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit="rlxy0k-orbit">
        <ul class="orbit-container" tabindex="0" style="height: 569.6px;">
            ...
            <li class="orbit-slide" data-slide="0" style="max-height: 569.6px; display: none;">
            <img src="https://placehold.it/2000x750&amp;text=1st">
            </li>
            <li class="orbit-slide" data-slide="1" style="position: relative; max-height: 569.6px; top: 0px; display: none;">
            <img src="https://placehold.it/2000x750&amp;text=2nd">
            </li>
            <li class="orbit-slide is-active" data-slide="2" aria-live="polite" style="position: relative; max-height: 569.6px; top: 0px; display: block;">
            <img src="https://placehold.it/2000x750&amp;text=3nd">
            </li>
            <li class="orbit-slide" data-slide="3" style="position: relative; display: none; max-height: 569.6px;">
            <img src="https://placehold.it/2000x750&amp;text=4nd">
            </li>
        </ul>
    </div>
